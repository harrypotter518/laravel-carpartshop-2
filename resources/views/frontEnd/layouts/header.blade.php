    ...
    <div class="header-bottom"><!--header-bottom-->
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <form action="{{ route('frontEnd.index') }}" method="GET" role="search" display="float">
                        <div class="search_box pull-right">
                            <input type="text" name="search_key" placeholder="Search" style="color:red" value="{{ $search_term ?? ''}}" />
                        </div>
                    </form>
                </div>
            </div>
